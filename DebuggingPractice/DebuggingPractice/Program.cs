...
namespace DebuggingPractice
{
    class Program
    {
        ...
        {
            CountTs("The thirty-three thieves thought that they thrilled the throne throughout Thursday.");
            Console.WriteLine(IsPalindrome("racecar"));
            Console.WriteLine(IsPalindrome("Onetwothree"));
        ...
        public static bool IsValidISBN(string ISBN)
        {
            ...
            for (int i = 0; i < number.Length; i++)
            {
                ...
                resultNum = resultNum + (int.Parse(number[i].ToString()) * (number.Length - i));
            }
